                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Upload Multi Image</h4><br>
                                <form method="post" action="{{ route('store.multi.image') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="image" class="form-control" type="file" name="multi_image[]" multiple="" >
                                            </div>
                                        </div>
                                        ...
                                        <!-- end row -->
                                        <input class="btn btn-info waves-effect waves-light" type="submit" name="submit" value = "Upload Image">
                                    </div>
