                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('all.blog.category') }}">All Bolg Category</a></li>
                                    <li><a href="{{ route('add.blog.category') }}">Add Bolg Category</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ route('all.message') }}">Messages</a></li>
